...
const defaultPermissions: Array<{
  ...
  },
  {
    ...
    permissionKey: "service.view",
    label: "Service-Center anzeigen",
    description: "Darf Servicefälle und Kundenannahmen anzeigen.",
    category: "Service-Center",
  },
  {
    permissionKey: "service.create",
    label: "Servicefälle erstellen",
    description: "Darf neue Service-, Reparatur- und Verkaufsfälle anlegen.",
    category: "Service-Center",
  },
  {
    permissionKey: "service.edit",
    label: "Servicefälle bearbeiten",
    description: "Darf Servicefälle bearbeiten und Status ändern.",
    category: "Service-Center",
  },
  {
    permissionKey: "service.delete",
    label: "Servicefälle löschen",
    description: "Darf Servicefälle löschen.",
    category: "Service-Center",
  },
  {
    permissionKey: "service.assign",
    label: "Servicefälle zuweisen",
    description: "Darf Servicefälle Benutzern zuweisen.",
    category: "Service-Center",
  },
  {
    permissionKey: "service.payments.manage",
    label: "Service-Zahlungen verwalten",
    description: "Darf Beträge, Zahlungen und Zahlungsstatus verwalten.",
    category: "Service-Center",
  },
  {
    permissionKey: "service.dashboard.view",
    label: "Service-Dashboard anzeigen",
    description: "Darf Service-Auswertungen und Übersichten anzeigen.",
    category: "Service-Center",
  },
  {
    permissionKey: "service.customers.manage",
    label: "Service-Kunden verwalten",
    description: "Darf Kundendaten im Service-Center verwalten.",
    category: "Service-Center",
  },
  {
