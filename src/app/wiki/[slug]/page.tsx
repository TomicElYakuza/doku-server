    ...
    return (
      <div className="space-y-8">
        <EmptyState
          ...
          description={error || "Diese Wiki-Seite existiert nicht."}
          action={
            <Link
              href="/wiki"
  ...
  if (!userCanSeePage(page)) {
    return (
      <div className="space-y-8">
        <EmptyState
          icon="🔒"
          title="Kein Zugriff auf diese Wiki-Seite"
          description="Diese Seite ist deiner Firma oder Abteilung nicht zugeordnet."
          action={
            <Link
              href="/wiki"
              className="app-accent-bg text-white px-5 py-3 rounded-2xl transition font-bold app-brand-shadow"
  ...
  return (
    <div className="space-y-8">
      <AppModal
        ...
        description="Wiki-Seite, Kategorie, Tags und Organisationszuordnung aktualisieren."
        size="2xl"
        footer={
          <>
            <button
