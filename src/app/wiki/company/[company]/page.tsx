...
export default function WikiCompanyPage() {
  const params =
    useParams();
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white border border-zinc-200 rounded-3xl p-6 shadow-sm">
        ...
        <input
          ...
          placeholder="Suche nach Titel, Inhalt oder Abteilung..."
