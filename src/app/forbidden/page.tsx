  ...
  return (
    <main className="min-h-screen bg-zinc-50 flex items-center justify-center px-6 py-12">
      <section className="w-full max-w-3xl bg-white border border-zinc-200 rounded-[2rem] shadow-sm overflow-hidden relative">
        <div className="absolute -right-24 -top-24 h-64 w-64 rounded-full bg-orange-500 opacity-10 blur-3xl" />
        <div className="absolute -left-24 -bottom-24 h-64 w-64 rounded-full app-accent-bg opacity-10 blur-3xl" />

        <div className="relative p-8 md:p-12 text-center">
          <div className="mx-auto h-20 w-20 rounded-3xl bg-orange-50 text-orange-700 flex items-center justify-center text-4xl font-black">
            403
          </div>

          <p className="mt-8 text-sm font-black uppercase tracking-[0.3em] text-orange-600">
            Kein Zugriff
          </p>
          ...
          <p className="mt-5 text-zinc-500 text-lg leading-8 max-w-2xl mx-auto">
            Für diesen Bereich fehlen dir die notwendigen Rechte. Wende dich an
            einen Administrator, wenn du Zugriff benötigst.
          </p>
          ...
          <div className="mt-8 bg-zinc-50 border border-zinc-100 rounded-3xl p-5 text-left">
            ...
            <p className="text-zinc-500 mt-2">
              Berechtigungen werden im Admin-Bereich über Rollen,
              Firmenrechte, Abteilungsrechte und Benutzerrechte verwaltet.
            </p>
          </div>
        </div>
      </section>
