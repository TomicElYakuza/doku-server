      ...
      <body>
        <main className="min-h-screen bg-zinc-50 flex items-center justify-center px-6 py-12">
          <section className="w-full max-w-3xl bg-white border border-zinc-200 rounded-[2rem] shadow-sm overflow-hidden relative">
            ...
            <div className="absolute -left-24 -bottom-24 h-64 w-64 rounded-full bg-indigo-500 opacity-10 blur-3xl" />
            ...
            <div className="relative p-8 md:p-12 text-center">
              ...
              <p className="mt-5 text-zinc-500 text-lg leading-8 max-w-2xl mx-auto">
                Es ist ein Fehler im Hauptlayout oder beim Starten der
                Anwendung aufgetreten. Du kannst es erneut versuchen oder die
                Seite neu laden.
              </p>
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                <button
                  type="button"
                  onClick={reset}
                  className="w-full sm:w-auto bg-zinc-950 text-white px-6 py-4 rounded-2xl transition font-bold shadow-sm"
                >
                  Erneut versuchen
                </button>
