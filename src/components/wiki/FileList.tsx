...
function getFileKey(pageSlug: string) {
...
export default function FileList({
  ...
  async function loadFiles() {
    ...
    try {
      ...
      console.error(
        "Wiki-Dateien konnten nicht geladen werden:",
        error,
      );
    } finally {
      setLoading(false);
    ...
    try {
      ...
      for (const file of selectedFiles) {
        ...
        void activityRepository.create({
          type: "created",
          title: "Wiki-Datei hochgeladen",
          description: `Datei "${file.name}" wurde zu Wiki-Seite "${pageSlug}" hochgeladen.`,
          entityType: "wiki",
          entityId: pageSlug,
          userName: "System",
          userEmail: "",
  ...
  async function handleDeleteFile(entry: FileEntry) {
    ...
    try {
      ...
      void activityRepository.create({
        type: "deleted",
        title: "Wiki-Datei gelöscht",
        description: `Datei "${entry.file.name}" wurde von Wiki-Seite "${pageSlug}" gelöscht.`,
        entityType: "wiki",
        entityId: pageSlug,
        userName: "System",
        userEmail: "",
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-5">
          <div>
            ...
            <p className="text-zinc-500 mt-1">
              Anhänge und Dokumente zu dieser Wiki-Seite.
            </p>
          </div>
